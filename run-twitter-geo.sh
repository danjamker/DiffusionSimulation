...
python MRJobNetworkX.py -r hadoop -v ./data/twitter-geo --network ./networks/twitter_geo_network.gpickle -o ./output/twitter-geo-innovation --no-output --conf-path ./etc/mrjob.conf
