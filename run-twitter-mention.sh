...
python MRJobNetworkX.py -r hadoop -v ./data/twitter-user-split --network ./networks/twitter_mention_network.gpickle -o ./output/twitter-mention-innovation --no-output --conf-path .mrjob.conf
